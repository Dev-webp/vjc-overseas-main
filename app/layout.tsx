...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Use the Head component from Next.js */}
        <Head>
          {/* Meta Tags */}
          <meta
            name="keywords"
            content="Best Immigration Visa Consultants in Hyderabad, Best Immigration Visa Consultants in Bangalore, Best Immigration Visa Consultants, Visa Consultants, Best Immigration Consultants, Best Visa Consultants, Immigration Visa Consultants, Visa Consultants, PR Visa, Permanent Residency Visa, Germany Opportunity Card, Study or Student Visa Immigration, Job Seeker Visa, Work Permit Visa"
          />
