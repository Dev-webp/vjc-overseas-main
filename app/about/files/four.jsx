                ...
                <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5">
                    ...
                    <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 lg:gap-x-14 gap-y-8 md:items-end">
                        <div className="space-y-3 md:space-y-6 md:col-span-2 lg:col-span-1 w-full max-w-3xl lg:max-w-none mx-auto lg:mx-0 text-center lg:text-left">
                            <h1 className="font-display font-semibold text-2xl md:text-3xl text-orange-500 dark:text-white uppercase">
                                Expert Visa Services Tailored to Your Global Goals
                            </h1>
                            <div className="text-gray-700 dark:text-gray-300 space-y-2 mx-auto max-w-2xl lg:max-w-none text-justify">
                                <p>
                            ...
                            <div className="flex justify-center lg:justify-start">
                                <Link href="#" className="px-6 h-11 flex items-center rounded-lg bg-orange-500 dark:bg-white text-white dark:text-gray-900 text-sm transition ease-linear hover:bg-gray-900">Consult Now</Link>
                            </div>
                            <div className="grid grid-cols-3 w-full italic">
                                <div>
                                    <h2 className="text-xl md:text-2xl font-display font-semiboldtext-gray-800 dark:text-gray-200">15years</h2>
                                    <span className="text-gray-600">Experience</span>
                                </div>
                                <div>
                                    <h2 className="text-xl md:text-2xl font-display font-semiboldtext-gray-800 dark:text-gray-200">+10000</h2>
                                    <span className="text-gray-600">Projects</span>
                                </div>
                                <div>
                                    <h2 className="text-xl md:text-2xl font-display font-semiboldtext-gray-800 dark:text-gray-200">95%</h2>
                        ...
                        <div className="flex justify-center mb-10">
                            <div className="max-w-full relative">
                                ...
                                <Image src="/2.webp" width={1240} height={1376} alt="Developer with laptop smile" className="relative w-full h-auto max-h-96 lg:max-h-[26rem] rounded-lg" />
                            </div>
                        </div>
                        <div className="space-y-3 lg:space-y-3">
                            <div className="flex items-start gap-x-2 p-2 md:p-3 lg:p-3 bg-orange-50 dark:bg-gray-900 border border-gray-100/80 dark:border-gray-900/80 rounded-lg">
                                ...
                                <div>
                                    <span className="font-semibold text-gray-800 dark:text-gray-200 text-lg ">Study Abroad Opportunities</span>
                                    <p className="text-gray-700 dark:text-gray-300 text-justify">
                                        We offer expert guidance to help you pursue your education overseas.
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-start gap-x-2 p-2 md:p-3 lg:p-4 bg-orange-50 dark:bg-gray-900 border border-gray-100/80 dark:border-gray-900/80 rounded-lg">
                                <span className="min-w-max text-orange-500 p-2 md:p-3 rounded-lg bg-gray-100 dark:bg-gray-800 border border-gray-100/70 dark:border-gray-900/70 dark:text-gray-200">
                                    <FaRegHandshake className="w-6 h-6" />
                                </span>
                                <div>
                                    <span className="font-semibold text-gray-800 dark:text-orange-200 text-lg">Work Opportunities Abroad</span>
                                    <p className="text-gray-700 dark:text-gray-300 text-justify">
                            ...
                            <div className="flex items-start gap-x-2 p-2 md:p-3 lg:p-4  bg-orange-50 dark:bg-gray-900 border border-gray-100/80 dark:border-gray-900/80 rounded-lg">
                                ...
                                <div>
                                    <span className="font-semibold text-gray-800  dark:text-gray-200 text-lg">Immigration Support</span>
                                    <p className="text-gray-700 dark:text-gray-300 text-justify">
                            ...
                            <div className="flex items-start gap-x-2 p-2 md:p-3 lg:p-4  bg-orange-50 dark:bg-gray-900 border border-gray-100/80 dark:border-gray-900/80 rounded-lg">
                                ...
                                <div>
                                    <span className="font-semibold text-gray-800 dark:text-gray-200 text-lg">Visa Processing</span>
                                    <p className="text-gray-700 dark:text-gray-300 text-justify">
