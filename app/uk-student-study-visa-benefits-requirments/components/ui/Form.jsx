...
const Form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/uk-student-study-visa-benefits-requirments/api/send-email', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="bg-white p-4 py-2 rounded-lg shadow-lg max-w-md mx-auto w-full h-[35rem] md:h-[32rem] lg:h-[32rem] shadow-orange-300 mb-6 lg:mb-14">
