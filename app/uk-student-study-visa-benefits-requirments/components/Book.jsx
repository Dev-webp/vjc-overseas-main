...
import Form from '@/app/uk-student-study-visa-benefits-requirments/components/ui/Form';  // Import your Form component
...
const Book = () => {
  ...
  return (
    <div className="flex justify-center items-center p-0 md:p-5 lg:p-5 mt-0 tablet:mt-10">
      <button
