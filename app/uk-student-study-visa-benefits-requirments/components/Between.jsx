...
const Between = () => {
  ...
  return (
    <div className="h-72 md:h-52 lg:h-52 bg-gradient-to-b from-orange-500 to-saffron flex items-center justify-center">
      ...
      <div className="text-white max-w-[60%] md:max-w-[40%] lg:max-w-[40%] tablet:max-w-[45%] text-center">
        <h3 className="text-2xl font-semibold mb-2 uppercase">Unlock Your Future with a UK Study Visa</h3>
        <p className="text-lg mb-4">Explore world-class education opportunities in the UK. Secure your spot today!</p>
        <a href={contactLink}>
